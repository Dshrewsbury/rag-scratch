...
def process_document(file_path=None, chunk_size=1500, chunk_overlap=100, batch_size=BATCH_SIZE):
    """
...
def store_in_qdrant(semantic_chunks, semantic_chunk_embeddings, collection_name="semantic"):
